...
class Request(Base):
    ...
    # ✅ НОВОЕ: финальная цена текстом (свободный формат)
    final_price_text = Column(String(200), nullable=True)
    ...
    # ✅ Важно для Offer: Offer.request -> back_populates="offers"
    offers = relationship(
        "Offer",
