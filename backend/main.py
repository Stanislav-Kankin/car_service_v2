...
from app.api.v1 import users, service_centers, cars, requests, offers, bonus
...
app.include_router(service_centers.router, prefix="/api/v1/service-centers", tags=["service_centers"])
